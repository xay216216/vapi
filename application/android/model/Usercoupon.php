...
class Usercoupon extends Model
{
    ...
    public function add($dataList){
        ...
        $data = [
            ...
            'order_id' => $dataList['order_id'] ? $dataList['order_id'] : '',
            ...
            'draw_messageone' => $dataList['draw_messageone'] ? $dataList['draw_messageone'] : '',
            'draw_messagetwo' => $dataList['draw_messagetwo'] ? $dataList['draw_messagetwo'] : '',
            'draw_messagethree' => $dataList['draw_messagethree'] ? $dataList['draw_messagethree'] : '',
            'draw_messagefour' => $dataList['draw_messagefour'] ? $dataList['draw_messagefour'] : '',
            ...
            'is_free' => $dataList['is_free'] ? intval($dataList['is_free']) : 0
        ];
